    ...
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div >
          ...
          <textarea  onChange={(e)=>setAbout(e.target.value)} value={about} className="border border-gray-200 rounded px-4 pt-2 w-full" type="text" placeholder="About Doctor" required />
        </div>
        <button type="submit" className="bg-gray-600 px-9 py-2 mt-4 text-white rounded-full">Add Doctor</button>
      </div>
    </form>
  );
};
